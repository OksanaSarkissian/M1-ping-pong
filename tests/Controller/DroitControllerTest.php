...
class DroitControllerTest extends WebTestCase
{
    ...
    private string $path = '/droit/';

    protected function setUp(): void
    {
        $this->client = static::createClient();
        $this->manager = static::getContainer()->get('doctrine')->getManager();
        $this->repository = $this->manager->getRepository(Droit::class);
    ...
    public function testIndex(): void
    {
        ...
        self::assertPageTitleContains('Droit index');
    ...
    public function testShow(): void
    {
        ...
        self::assertResponseStatusCodeSame(200);
        self::assertPageTitleContains('Droit');
    ...
    public function testEdit(): void
    {
        ...
        self::assertResponseRedirects('/droit/');
